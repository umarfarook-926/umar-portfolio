        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
              I'm <span className="text-cyan-400 font-semibold">Mohamed Umar Farook</span>, an aspiring full-stack developer with a strong passion for building modern, responsive, and user-friendly web applications.
            </p>

            <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
              As a fresher, I bring a solid foundation in <span className="text-blue-400 font-semibold">front-end and back-end technologies</span>, and I’m continuously learning and exploring the latest trends in web development. I'm focused on writing clean code, building accessible UIs, and solving real-world problems through technology.
            </p>
            ...
            >
              {["Quick Learner", "Responsive Design", "Collaborative", "Mobile-First Approach","API Understanding"].map((tag, i) => (
                <span 
                  key={i}
